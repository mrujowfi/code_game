...
if __name__ == '__main__':
    ...
    try:
        if dev:
            ...
            dict_args['arg'] = '''
level=132&x=47&y=47&map=
'''
            #create processes
            processed = []
            for i in [3, 4, 2, 1]:
